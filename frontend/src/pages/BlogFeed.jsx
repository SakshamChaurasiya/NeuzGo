    ...
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
      ...
      {loading ? (
        <div className="space-y-12">
          {page === 1 && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-pulse rounded-2xl border border-charcoal-100 overflow-hidden">
              <div className="min-h-[300px] sm:min-h-[400px] lg:col-span-7 bg-charcoal-100"></div>
              <div className="p-8 lg:p-12 lg:col-span-5 bg-charcoal-900 space-y-6">
